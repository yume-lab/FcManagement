 ...
 *
 */
class UserStoresFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'user_id' => ['type' => 'unique', 'columns' => ['user_id', 'store_id', 'role_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'role_id' => 1,
            'is_deleted' => 1,
            'created' => '2015-10-12 08:02:11',
            'updated' => '2015-10-12 08:02:11'
        ],
    ];
}
