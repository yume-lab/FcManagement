 ...
 *
 */
class ShiftTablesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'month' => ['type' => 'integer', 'length' => 2, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'uni_shift_tables' => ['type' => 'unique', 'columns' => ['store_id', 'year', 'month'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'is_deleted' => 1,
            'created' => '2015-10-15 09:41:03',
            'updated' => '2015-10-15 09:41:03'
        ],
    ];
}
