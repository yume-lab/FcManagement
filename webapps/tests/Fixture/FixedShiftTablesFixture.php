...
/**
 * FixedShiftTablesFixture
 *
 */
class FixedShiftTablesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'target_ym' => ['type' => 'integer', 'length' => 6, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'uni_shift_tables' => ['type' => 'unique', 'columns' => ['store_id', 'target_ym', 'hash'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'is_deleted' => 1,
            'created' => '2015-10-26 06:27:59',
            'updated' => '2015-10-26 06:27:59'
        ],
    ];
}
