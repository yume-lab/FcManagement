...
/**
 * LatestTimeCardsFixture
 *
 */
class LatestTimeCardsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'uni_latest_time_cards' => ['type' => 'unique', 'columns' => ['store_id', 'employee_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'created' => '2015-11-11 07:33:00',
            'updated' => '2015-11-11 07:33:00'
        ],
    ];
}
